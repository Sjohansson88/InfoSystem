...
namespace InfoSystem.Migrations
{
    ...
    [Migration("20241023200246_Update driver")]
            ...
            modelBuilder.Entity("InfoSystem.Models.Driver", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            NoteDate = new DateTime(2024, 8, 23, 22, 2, 45, 767, DateTimeKind.Local).AddTicks(1251),
                        ...
                        new
                        {
                            ...
                            NoteDate = new DateTime(2024, 9, 23, 22, 2, 45, 767, DateTimeKind.Local).AddTicks(1348),
                            NoteDescription = "Added to System",
                        ...
                        new
                        {
                            ...
                            NoteDate = new DateTime(2024, 9, 23, 22, 2, 45, 767, DateTimeKind.Local).AddTicks(1356),
                            NoteDescription = "Added to System",
                            ResponsibleEmployee = "Bob Smith",
                            TotalBeloppIn = 150m,
                            TotalBeloppUt = 0m
            ...
            modelBuilder.Entity("InfoSystem.Models.Event", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            BeloppUt = 100m,
                            DriverID = 1,
                            NoteDate = new DateTime(2024, 10, 13, 22, 2, 45, 767, DateTimeKind.Local).AddTicks(1419),
                        ...
                        new
                        {
                            ...
                            BeloppUt = 50m,
                            DriverID = 1,
                            NoteDate = new DateTime(2024, 10, 3, 22, 2, 45, 767, DateTimeKind.Local).AddTicks(1431),
                        ...
                        new
                        {
                            ...
                            BeloppUt = 100m,
                            DriverID = 2,
                            NoteDate = new DateTime(2024, 10, 18, 22, 2, 45, 767, DateTimeKind.Local).AddTicks(1436),
                        ...
                        new
                        {
                            ...
                            BeloppUt = 0m,
                            DriverID = 3,
                            NoteDate = new DateTime(2024, 10, 20, 22, 2, 45, 767, DateTimeKind.Local).AddTicks(1440),
